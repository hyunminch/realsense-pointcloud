...
public:
    ...
    void extract_descriptors(rgb_point_cloud_const_pointer input, i_point_cloud_pointer keypoints, pcl::PointCloud<pcl::FPFHSignature33>::Ptr features) {
        pcl::Feature<rgb_point, feature_type>::Ptr feature_extractor(new pcl::FPFHEstimationOMP<rgb_point_cloud, pcl::Normal, feature_type>);
        feature_extractor->setSearchMethod(pcl::search::Search<rgb_point>::Ptr(new pcl::search::KdTree<rgb_point_cloud>));
    ...
    void find_correspondences(pcl::PointCloud<feature_type>::Ptr source, pcl::PointCloud<feature_type>::Ptr target, std::vector<int>& correspondences) {
    ...
    void filterCorrespondences(std::vector<int>& source2target, std::vector<int>& target2source, pcl::CorrespondencesPtr correspondences, i_point_cloud_pointer source_keypoints, i_point_cloud_pointer target_keypoints) {
    ...
    void determineInitialTransformation(i_point_cloud_pointer source_keypoints, i_point_cloud_pointer target_keypoints, pcl::CorrespondencesPtr correspondences, Eigen::Matrix4f *initial_transformation_matrix, rgb_point_cloud_pointer source_segmented, rgb_point_cloud_pointer source_transformed) {
    ...
    void determineFinalTransformation(rgb_point_cloud_pointer source_transformed, rgb_point_cloud_pointer target_segmented, rgb_point_cloud_pointer source_registered, Eigen::Matrix4f *transformation_matrix) {
